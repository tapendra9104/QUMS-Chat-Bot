...
def load_settings() -> Settings:
    ...
    settings = Settings(
        ...
        substitution_poll_interval_minutes=env_int("SUBSTITUTION_POLL_INTERVAL_MINUTES", 1, minimum=1),
        monitor_poll_interval_minutes=env_int("MONITOR_POLL_INTERVAL_MINUTES", 1, minimum=1),
